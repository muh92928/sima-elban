    ...
    <div className="space-y-6 print:space-y-4">
      ...
      >
        ...
        <p className="text-slate-400 font-medium text-sm @tablet:text-base max-w-2xl leading-relaxed">
            Sistem Informasi Manajemen Inventaris & Status Operasional <br className="hidden @tablet:block" />
        ...
        <div className="flex flex-col pc:flex-row items-center gap-3 flex-1">
          ...
          <div className="w-full pc:flex-1 relative group">
              ...
              <select 
                  ...
                  className="w-full bg-slate-900/50 border border-white/10 rounded-xl py-2.5 pl-10 pr-4 text-sm text-white appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 cursor-pointer hover:bg-slate-900/70 transition-all"
              >
          ...
          <div className="w-full pc:flex-1 self-stretch pc:self-auto relative group">
               ...
               >
                  {reportDate ? (
                      new Intl.DateTimeFormat('id-ID', { month: 'long', year: 'numeric' }).format(reportDate)
                  ) : (
