...
export default function JadwalClient({ initialData, user }: JadwalClientProps) {
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-slate-400 font-medium text-sm @tablet:text-base max-w-2xl leading-relaxed">
            Sistem Perencanaan & Monitoring Penugasan Personel <br className="hidden @tablet:block" />
      ...
      >
        {/* Filter Group: Search, Location, Time */}
