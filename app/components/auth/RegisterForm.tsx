...
export default function RegisterForm({ onSuccess, onLoginClick }: RegisterFormProps) {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // We pass user details here so the Database Trigger can handle the insert
      // This avoids RLS issues since the Trigger runs with system privileges
      ...
      // If registration is successful, the Trigger will handle the 'akun' table insert.
      // We sign out immediately because we want the user to login manually with NIP.
      if (authData.user) {
