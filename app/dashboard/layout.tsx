...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen w-full bg-[#030712] text-white font-sans selection:bg-indigo-500/30 flex print:bg-white print:text-black">
        ...
        <div className="fixed top-0 left-0 right-0 h-16 bg-[#030712]/80 backdrop-blur-md border-b border-white/5 flex items-center justify-between px-4 md:hidden z-30">
        ...
        {/* Main Content Area */}
        <main className="flex-1 ml-0 md:ml-[250px] print:ml-0 p-4 md:p-8 pt-20 md:pt-8 relative min-h-screen overflow-hidden">
            {/* Background Atmosphere */}
            <div className="fixed top-0 left-0 md:left-[250px] right-0 h-96 bg-gradient-to-b from-blue-900/10 to-transparent pointer-events-none" />
